...
export const sendAccountDeletionReminders = async () => {
  try {
    ...
    console.log(`✅ Account deletion reminder process completed: ${totalSent} emails sent (${results.fifteenDayReminders.length} reminders, ${results.finalWarnings.length} final warnings), ${results.errors.length} errors`);

...
// Connect to MongoDB
mongoose.connect('mongodb://localhost:27017/urbansetu')
  .then(async () => {
    ...
    try {
      ...
      if (about) {
        console.log('Found existing About document, updating with new fields...');
        
        // Update the document with new fields if they don't exist
        const updateData = {};
        ...
        console.log('Successfully created new About document');
      }

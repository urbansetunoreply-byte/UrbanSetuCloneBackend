      ...
      <div className="bg-gradient-to-br from-blue-50 to-purple-100 min-h-screen py-4 sm:py-6 lg:py-10 px-2 sm:px-4 md:px-8">
        <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-lg p-4 sm:p-6 relative">
          ...
          <div className="mt-4 sm:mt-6">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">All Properties ({listings.length})</h2>
            ...
            {!loading && listings.length === 0 && (
              <div className="text-center py-6 sm:py-8">
                <img src={duckImg} alt="No properties found" className="w-48 h-48 sm:w-72 sm:h-72 object-contain mx-auto mb-4" />

        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-4 gap-y-8 md:gap-8">
          ...
          <div className="col-span-2 md:col-span-1 space-y-3">
            ...
            <div className="flex gap-4 pt-2">
              <a href="mailto:contact@urbansetu.com" target="_blank" rel="noopener noreferrer" title="Email" className="text-gray-500 hover:text-blue-500 transition-colors"><FaEnvelope className="text-lg" /></a>

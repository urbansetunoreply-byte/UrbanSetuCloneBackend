  ...
  const getNotificationIcon = (type) => {
    ...
    switch (type) {
      case 'property_edited':
        return (
          <div className={`${containerBase} bg-blue-100 text-blue-600`}>
            <FaEdit className={iconBase} />
          </div>
        );
      case 'property_deleted':
        return (
          <div className={`${containerBase} bg-red-100 text-red-600`}>
            <FaTrash className={iconBase} />
          </div>
        );
      case 'appointment_updated':
        return (
          <div className={`${containerBase} bg-green-100 text-green-600`}>
            <FaCalendarAlt className={iconBase} />
          </div>
        );
      case 'admin_message':
        return (
          <div className={`${containerBase} bg-purple-100 text-purple-600`}>
            <FaEnvelope className={iconBase} />
          </div>
        );
      case 'appointment_booked':
        return (
          <div className={`${containerBase} bg-sky-100 text-sky-600`}>
            <FaCalendarAlt className={iconBase} />
          </div>
        );
      ...
      case 'appointment_accepted_by_seller':
        return (
          <div className={`${containerBase} bg-emerald-100 text-emerald-600`}>
      ...
      case 'watchlist_property_sold':
        return (
          <div className={`${containerBase} bg-amber-100 text-amber-600`}>
            <FaTimes className={iconBase} />
          </div>
        );
      default:
        return (
          <div className={`${containerBase} bg-gray-100 text-gray-600`}>
                ...
                <div className="flex-1 overflow-hidden flex flex-col pt-2">
                  ...
                  {activeTab === 'notifications' ? (
                    <>
                      ...
                      {/* Notifications List Container */}
                      <div className="notification-scroll-area-mobile bg-gray-50/50 flex-1 px-4 py-2">
                        {notifications.length === 0 ? (
                          <div className="flex flex-col items-center justify-center h-64 text-center">
                            ...
                            <p className="text-sm text-gray-500 max-w-[200px]">No new notifications for you right now.</p>
                          </div>
                        ) : (
                            ...
                            {notifications.map((notification, index) => (
                              <div
                                ...
                                className={`notification-card p-4 rounded-2xl border transition-all duration-300 animate-fadeInNotification ${!notification.isRead
                                  ...
                                  : 'bg-white/60 border-gray-100 grayscale-[0.3]'
                                  }`}
                                ...
                                <div className="flex gap-4">
                                  ...
                                  <div className="flex-1 min-w-0">
                                    <div className="flex items-start justify-between gap-2">
                                      <h4 className={`text-sm font-bold truncate ${!notification.isRead ? 'text-gray-900' : 'text-gray-500'}`}>
                                        {notification.title}
                                      </h4>
                                    ...
                                    <p className={`text-xs mt-1 leading-relaxed ${!notification.isRead ? 'text-gray-600 font-medium' : 'text-gray-400'}`}>
                                      {notification.link ? (
                                        <button
                                          onClick={() => {

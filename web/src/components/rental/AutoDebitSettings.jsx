    ...
    <div className="bg-white rounded-xl shadow-lg p-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-semibold text-blue-800 mb-1">About Auto-Debit</p>
      ...
      <div className="bg-gray-50 rounded-lg p-6 mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="font-semibold text-lg text-gray-800 mb-1">Enable Auto-Debit</h3>
      ...
      {/* Current Status */}
      <div className={`rounded-lg p-4 ${settings.enabled ? 'bg-green-50 border border-green-200' : 'bg-gray-50 border border-gray-200'}`}>
        <div className="flex items-center gap-3">
          {settings.enabled ? (
            <>
              <FaCheckCircle className="text-green-600 text-xl" />
              <div>
                <p className="font-semibold text-green-800">Auto-Debit Active</p>
            ...
            <>
              ...
              <div>
                <p className="font-semibold text-gray-800">Auto-Debit Disabled</p>
                <p className="text-sm text-gray-600">

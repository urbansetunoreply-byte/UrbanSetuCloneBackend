...
const AdminBlogsSkeleton = () => {
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
            ...
            <div className="bg-gray-800 pb-20 pt-10 px-4 shadow-xl relative overflow-hidden">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center relative z-10">
                    ...
                    <div className="h-12 w-48 bg-gray-700 rounded-xl animate-pulse"></div>
                </div>
            </div>
            ...
            <div className="flex-grow max-w-7xl mx-auto px-4 w-full -mt-10 relative z-10 pb-20">
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    ...
                    <div className="hidden lg:flex px-6 py-4 border-b border-gray-100 bg-gray-50/80 gap-4">
                        ...
                        <div className="w-1/6 h-4 bg-gray-200 rounded animate-pulse"></div>
                        <div className="w-1/6 h-4 bg-gray-200 rounded animate-pulse"></div>
                        <div className="w-1/12 h-4 bg-gray-200 rounded animate-pulse"></div>
                    </div>
                        ...
                        {[1, 2, 3, 4, 5].map((i) => (
                            <div key={i} className="p-4 lg:px-6 lg:py-4 flex flex-col lg:flex-row items-center gap-4">
                                ...
                                <div className="w-full lg:w-1/6 flex justify-between lg:justify-center items-center">
                                    <span className="lg:hidden text-gray-400 text-sm">Status</span>
                                    <div className="h-6 w-20 bg-gray-200 rounded-full animate-pulse"></div>
                                </div>

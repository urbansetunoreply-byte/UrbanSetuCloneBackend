            ...
            <div className="max-w-6xl w-full mx-auto px-2 sm:px-4 md:px-8 py-8 overflow-x-hidden">
                <div className="bg-white rounded-xl shadow-lg p-6">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                        ...
                        <div className="h-10 w-48 bg-purple-200 rounded-lg mt-4 md:mt-0"></div>
                    </div>

                    {/* Filters Skeleton - Identical toAdmin Listings but slightly simplified if needed based on the page content */}
                            ...
                            <div key={i} className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                                ...
                                <div className="p-4 space-y-3">
                                    ...
                                    <div className="flex gap-2 pt-2">
                                        <div className="flex-1 h-9 bg-blue-200 rounded"></div>
                                        <div className="flex-1 h-9 bg-yellow-200 rounded"></div>
                                        <div className="flex-1 h-9 bg-red-200 rounded"></div>
                                    </div>
                                </div>
                            </div>
                        ))}

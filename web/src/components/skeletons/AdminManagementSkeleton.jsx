...
export default function AdminManagementSkeleton() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-100 dark:from-gray-900 dark:to-gray-950 py-10 px-2 md:px-8 animate-pulse font-sans transition-colors duration-300">
            <div className="max-w-6xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 transition-colors duration-300">
                ...
                {/* Tabs and Stats */}
                <div className="flex flex-wrap gap-4 border-b border-gray-200 dark:border-gray-700 pb-4 mb-8">
                ...
                <div className="space-y-4">
                    ...
                    {[1, 2, 3, 4, 5].map((i) => (
                        <div key={i} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 rounded-xl border border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50 gap-4 transition-colors duration-300">

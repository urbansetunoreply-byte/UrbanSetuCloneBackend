                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
                        {[1, 2, 3, 4, 5, 6].map((i) => (
                            <div key={i} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm overflow-hidden transition-colors duration-300">
                                {/* Image Placeholder */}
                                <div className="relative h-48 bg-gray-300 dark:bg-gray-700 rounded-t-lg"></div>

                                {/* Content */}
                                <div className="p-4 space-y-3">
                                    <div className="h-6 w-3/4 bg-gray-200 dark:bg-gray-700 rounded"></div>
                                    <div className="h-5 w-24 bg-green-100 dark:bg-green-900/20 rounded"></div>
                                    ...
                                    <div className="flex justify-between items-center mb-2">
                                        <div className="h-6 w-24 bg-blue-100 dark:bg-blue-900/20 rounded"></div>
                                        <div className="h-4 w-16 bg-green-100 dark:bg-green-900/20 rounded"></div>
                                    </div>
...
export default AdminListingsSkeleton;

    ...
    return (
        <div className="bg-gray-50 dark:bg-gray-950 min-h-screen relative overflow-hidden font-sans transition-colors duration-300">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
                <div className="absolute top-[-10%] left-[-10%] w-96 h-96 bg-gray-200 dark:bg-gray-800 rounded-full filter blur-3xl opacity-30 transition-colors duration-300"></div>
            </div>
            ...
            <div className="relative z-10">
                ...
                <div className="relative pt-20 pb-16 lg:pt-32 lg:pb-28 overflow-hidden">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center flex flex-col items-center">
                        ...
                        {/* Platform Badge Pill */}
                        <div className="mb-8 w-64 h-10 bg-gray-200 dark:bg-gray-800 rounded-full animate-pulse transition-colors duration-300"></div>
                        ...
                        <div className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto w-full">
                            {[1, 2, 3, 4].map((i) => (
                                <div key={i} className="bg-white/50 dark:bg-gray-800/50 p-6 rounded-2xl shadow-lg border border-white/50 dark:border-gray-700 animate-pulse transition-colors duration-300">
                                    <div className="w-12 h-12 bg-gray-200 dark:bg-gray-700 rounded-xl mx-auto mb-3 transition-colors duration-300"></div>
                                    <div className="w-24 h-8 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-2 transition-colors duration-300"></div>
                                    <div className="w-16 h-4 bg-gray-200 dark:bg-gray-700 rounded mx-auto transition-colors duration-300"></div>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    ...
                    <div className="rounded-3xl overflow-hidden shadow-2xl bg-gray-200 dark:bg-gray-800 h-[400px] md:h-[500px] lg:h-[600px] w-full animate-pulse relative transition-colors duration-300">
                        <div className="absolute bottom-12 left-12 space-y-4">
                            <div className="w-32 h-8 bg-gray-300 dark:bg-gray-700 rounded-full transition-colors duration-300"></div>
                            <div className="w-96 h-12 bg-gray-300 dark:bg-gray-700 rounded transition-colors duration-300"></div>
                            <div className="w-40 h-6 bg-gray-300 dark:bg-gray-700 rounded transition-colors duration-300"></div>
                        </div>
                    </div>
                </div>

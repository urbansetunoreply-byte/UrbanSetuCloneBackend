...
export default function DeviceManagementSkeleton() {
    return (
        <div className="min-h-screen bg-gray-50 py-12 relative overflow-hidden animate-pulse font-sans">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    {/* Limit Card */}
                    <div className="lg:col-span-2 bg-white border border-blue-100 rounded-2xl p-6 shadow-sm flex items-start gap-4">
                    ...
                    <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm flex flex-col justify-center items-center text-center space-y-3">
                                ...
                                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                                    <div className="flex items-start gap-5 flex-1 w-full">
                                        ...
                                        <div className="flex-1 min-w-0 space-y-3">
                                            <div className="flex items-center gap-2">
                                                <div className="h-5 w-32 bg-gray-200 rounded"></div>
                                                {i === 1 && <div className="h-5 w-24 bg-gray-200 rounded-full"></div>}
                                            </div>
                ...
                <div className="mt-8 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm flex items-start gap-4">
                    <div className="h-10 w-10 bg-gray-200 rounded-full shrink-0"></div>
                    <div className="flex-1 space-y-2">

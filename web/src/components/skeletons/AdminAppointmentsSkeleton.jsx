...
export default function AdminAppointmentsSkeleton() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-100 dark:from-gray-900 dark:to-gray-950 py-10 px-2 md:px-8 animate-pulse font-sans transition-colors duration-300">
            ...
            <div className="max-w-7xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-colors duration-300">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-6">
                    <div className="h-10 w-64 bg-gray-300 dark:bg-gray-700 rounded"></div>
                ...
                <div className="h-4 w-full max-w-2xl mx-auto bg-gray-200 dark:bg-gray-700 rounded mb-6"></div>
                ...
                {/* Table Skeleton */}
                <div className="border border-gray-100 dark:border-gray-700 rounded-lg overflow-hidden bg-white dark:bg-gray-800">
                    <div className="h-12 bg-gray-200 dark:bg-gray-700 border-b border-gray-300 dark:border-gray-600"></div> {/* Header Row */}
                    {[1, 2, 3, 4, 5, 6].map((i) => (
                        <div key={i} className="flex items-center p-4 border-b border-gray-100 dark:border-gray-700">

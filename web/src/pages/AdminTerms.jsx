...
export default function AdminTerms() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4 transition-colors duration-300">
      <h1 className="text-4xl font-bold mb-6 text-blue-700 dark:text-blue-400 transition-colors">Admin Terms & Conditions</h1>
      <div className="space-y-6 text-gray-800 dark:text-gray-300 text-base transition-colors">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-600 dark:text-blue-300 transition-colors">1. Admin Responsibilities</h2>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-600 dark:text-blue-300 transition-colors">2. Security & Compliance</h2>
        <ul className="list-disc ml-6 space-y-3">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-600 dark:text-blue-300 transition-colors">3. Platform Rules</h2>
        <ul className="list-disc ml-6 space-y-3">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-600 dark:text-blue-300 transition-colors">5. Property Moderation</h2>
        <ul className="list-disc ml-6 space-y-3">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-600 dark:text-blue-300 transition-colors">6. Dispute Handling</h2>
        <ul className="list-disc ml-6 space-y-3">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-600 dark:text-blue-300 transition-colors">7. Data & Access Management</h2>
        <ul className="list-disc ml-6 space-y-3">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-600 dark:text-blue-300 transition-colors">8. Financial & Escrow Oversight</h2>
        <ul className="list-disc ml-6 space-y-3">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-600 dark:text-blue-300 transition-colors">9. Liability</h2>
        <ul className="list-disc ml-6 space-y-3">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-600 dark:text-blue-300 transition-colors">10. Call, Chat & Live Monitor Oversight</h2>
        <ul className="list-disc ml-6 space-y-3">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-600 dark:text-blue-300 transition-colors">11. Incident Response & Escalations</h2>
        <ul className="list-disc ml-6 space-y-3">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-600 dark:text-blue-300 transition-colors">12. SetuCoin Economy & Loyalty Oversight</h2>
        <ul className="list-disc ml-6 space-y-3">

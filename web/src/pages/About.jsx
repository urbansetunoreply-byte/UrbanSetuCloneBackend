...
import { FaBullseye, FaGlobe, FaUsers, FaShieldAlt, FaUserFriends, FaEnvelope, FaStar, FaPhone, FaMobileAlt, FaDownload, FaAndroid } from 'react-icons/fa';
    ...
    <div className="bg-gradient-to-br from-blue-50 to-purple-100 min-h-screen py-10 px-2 md:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-6 relative">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-700 text-lg whitespace-pre-line mb-6">
            {aboutData.contact || ''}
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="flex items-center gap-2 text-blue-700 hover:text-blue-800 hover:bg-blue-200 p-2 rounded-lg transition-all duration-200 w-full text-left"
                >
                  <FaMobileAlt className="text-blue-600" />
                  <span className="font-medium">+1 (555) 123-4567</span>
                </button>
                <button
                  onClick={() => handlePhoneClick('+1-555-987-6543')}
                  className="flex items-center gap-2 text-blue-700 hover:text-blue-800 hover:bg-blue-200 p-2 rounded-lg transition-all duration-200 w-full text-left"
                >
              ...
              <p className="text-xs text-blue-600 mt-2">
                📱 Mobile: Tap to call | 💻 Desktop: Click to copy
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-4 border border-green-200">
              ...
              <div className="space-y-2">
                <a
                  href="mailto:support@urbansetu.com"
                  className="flex items-center gap-2 text-green-700 hover:text-green-800 hover:bg-green-200 p-2 rounded-lg transition-all duration-200"
                >
                  <FaEnvelope className="text-green-600" />
                  <span className="font-medium">support@urbansetu.com</span>
                </a>
                <a
                  href="mailto:info@urbansetu.com"
                  className="flex items-center gap-2 text-green-700 hover:text-green-800 hover:bg-green-200 p-2 rounded-lg transition-all duration-200"
                >
                  <FaEnvelope className="text-green-600" />

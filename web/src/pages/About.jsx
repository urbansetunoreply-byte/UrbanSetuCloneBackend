    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 py-10 px-4 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="max-w-6xl mx-auto space-y-8 relative z-10 animate-fade-in">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-green-900/10 p-8 transition-colors">
          ...
          <p className="text-lg text-slate-700 dark:text-gray-300 text-center mb-8 whitespace-pre-line leading-relaxed">
            {aboutData.contact || ''}
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-lg p-6 border border-blue-200 dark:border-blue-800 transition-colors">
              ...
              <div className="space-y-3">
                <button onClick={() => handlePhoneClick('+1-555-123-4567')} className="flex items-center gap-3 text-blue-700 dark:text-blue-300 hover:text-blue-800 dark:hover:text-white hover:bg-blue-200 dark:hover:bg-blue-800/50 p-3 rounded-lg transition-all duration-200 w-full text-left">
                  <FaMobileAlt className="text-blue-600 dark:text-blue-400" />
                  <span className="font-medium">+1 (555) 123-4567</span>
                </button>
                <button onClick={() => handlePhoneClick('+1-555-987-6543')} className="flex items-center gap-3 text-blue-700 dark:text-blue-300 hover:text-blue-800 dark:hover:text-white hover:bg-blue-200 dark:hover:bg-blue-800/50 p-3 rounded-lg transition-all duration-200 w-full text-left">
            ...
            <div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-lg p-6 border border-green-200 dark:border-green-800 transition-colors">
              ...
              <div className="space-y-3">
                <a href="mailto:support@urbansetu.com" className="flex items-center gap-3 text-green-700 dark:text-green-300 hover:text-green-800 dark:hover:text-white hover:bg-green-200 dark:hover:bg-green-800/50 p-3 rounded-lg transition-all duration-200">
                  <FaEnvelope className="text-green-600 dark:text-green-400" />
                  <span className="font-medium">support@urbansetu.com</span>
                </a>
                <a href="mailto:info@urbansetu.com" className="flex items-center gap-3 text-green-700 dark:text-green-300 hover:text-green-800 dark:hover:text-white hover:bg-green-200 dark:hover:bg-green-800/50 p-3 rounded-lg transition-all duration-200">
                  <FaEnvelope className="text-green-600 dark:text-green-400" />
      ...
      <div className="max-w-4xl mx-auto bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-green-900/10 p-6 mt-6 transition-colors">
        <div className="mb-2 bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-xl p-6 border border-green-200 dark:border-green-800 transition-colors">
          <div className="text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Available on Android</h2>
                <p className="text-gray-600 dark:text-gray-400">Get the UrbanSetu mobile app for the best experience</p>
              </div>
            </div>
      ...
      <div className="max-w-4xl mx-auto bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-blue-900/10 p-6 mt-6 flex flex-col items-center transition-colors">
        <h2 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">Connect with Us</h2>
        <div className="flex gap-4 text-2xl mb-2 text-gray-600 dark:text-gray-400">
          <a href={`mailto:${aboutData.socialLinks?.email || 'contact@urbansetu.com'}`} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors" target="_blank" rel="noopener noreferrer" title="Email"><FaEnvelope /></a>
          <a href={aboutData.socialLinks?.instagram || "https://instagram.com/urbansetu"} className="hover:text-pink-600 dark:hover:text-pink-400 transition-colors" target="_blank" rel="noopener noreferrer" title="Instagram"><svg className="inline w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M7.75 2h8.5A5.75 5.75 0 0 1 22 7.75v8.5A5.75 5.75 0 0 1 16.25 22h-8.5A5.75 5.75 0 0 1 2 16.25v-8.5A5.75 5.75 0 0 1 7.75 2zm0 1.5A4.25 4.25 0 0 0 3.5 7.75v8.5A4.25 4.25 0 0 0 7.75 20.5h8.5A4.25 4.25 0 0 0 20.5 16.25v-8.5A4.25 4.25 0 0 0 16.25 3.5zm4.25 2.25a5.25 5.25 0 1 1 0 10.5a5.25 5.25 0 0 1 0-10.5zm0 1.5a3.75 3.75 0 1 0 0 7.5a3.75 3.75 0 0 0 0-7.5zm5.25 1.25a1 1 0 1 1 0 2a1 1 0 0 1 0-2z" /></svg></a>
          <a href={aboutData.socialLinks?.x || "https://x.com/urbansetu"} className="hover:text-gray-900 dark:hover:text-white transition-colors" target="_blank" rel="noopener noreferrer" title="X"><svg className="inline w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M17.53 2H21l-7.19 8.21L22 22h-6.56l-5.18-6.98L2.47 22H-1l7.61-8.7L2 2h6.56l4.93 6.64L17.53 2zm-2.1 16.5h2.13l-5.98-8.06l-2.13-2.87H7.47l5.98 8.06l2.13 2.87z" /></svg></a>
          <a href={aboutData.socialLinks?.facebook || "https://facebook.com/urbansetu"} className="hover:text-blue-700 dark:hover:text-blue-500 transition-colors" target="_blank" rel="noopener noreferrer" title="Facebook"><svg className="inline w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M22.675 0h-21.35C.595 0 0 .592 0 1.326v21.348C0 23.408.595 24 1.326 24H12.82v-9.294H9.692v-3.622h3.127V8.413c0-3.1 1.893-4.788 4.659-4.788c1.325 0 2.463.099 2.797.143v3.24l-1.918.001c-1.504 0-1.797.715-1.797 1.763v2.313h3.587l-.467 3.622h-3.12V24h6.116C23.406 24 24 23.408 24 22.674V1.326C24 .592 23.406 0 22.675 0" /></svg></a>
          <a href={aboutData.socialLinks?.youtube || "https://youtube.com/@urbansetu"} className="hover:text-red-600 dark:hover:text-red-400 transition-colors" target="_blank" rel="noopener noreferrer" title="YouTube"><svg className="inline w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a2.994 2.994 0 0 0-2.112-2.112C19.454 3.5 12 3.5 12 3.5s-7.454 0-9.386.574A2.994 2.994 0 0 0 .502 6.186C0 8.118 0 12 0 12s0 3.882.502 5.814a2.994 2.994 0 0 0 2.112 2.112C4.546 20.5 12 20.5 12 20.5s7.454 0 9.386-.574a2.994 2.994 0 0 0 2.112-2.112C24 15.882 24 12 24 12s0-3.882-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" /></svg></a>
        </div>

              ...
              <form onSubmit={handleVerification} className="space-y-5 relative z-10">
                <div>
                  ...
                  <FormField
                    ...
                    inputClassName={`transition-all duration-200 focus:ring-2 focus:ring-red-500/20 ${(emailVerified && !emailEditMode) || otpLoading ? 'bg-gray-100 cursor-not-allowed border-green-500 pr-20' : (emailVerified ? 'border-green-500' : 'border-gray-300')} hover:border-red-500`}
                    required
                  />
                ...
                <FormField
                  ...
                  endAdornment={
                    <button
                      ...
                      className="absolute right-3 top-1/2 transform -translate-y-1/2 text-green-600 hover:text-green-700 p-1 rounded hover:bg-green-50 transition-all"

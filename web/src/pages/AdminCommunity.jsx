...
import {
    ...
    FaCalendarAlt, FaEllipsisH, FaTimes, FaImage, FaTrash
} from 'react-icons/fa';
                            ...
                            posts.map(post => (
                                <div key={post._id} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                                    ...
                                    <div className="mb-4 relative">
                                        {post.isPinned && (
                                            <div className="absolute -top-12 right-0 bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full flex items-center gap-1">
                                                <FaMapMarkerAlt className="text-xs" /> Pinned
                                            </div>
                                        )}
